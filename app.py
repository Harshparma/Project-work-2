...
vectorizerEnternment = joblib.load(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Enternment_services\Entertenment_service_vectrorizer.pkl')
vectorizerFoodCatering = joblib.load(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Food_Catering\Food_Catering_service_vectrorizer.pkl')
vectorizerGroundService = joblib.load(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Ground_service\Ground_service_vectrorizer.pkl')
vectorizerSeatComfort = joblib.load(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Comfort_seat_service\Comfart_seat_service_vectrorizer.pkl')
vectorizerInFlight = joblib.load(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\In_Flight_services\In_Flight_service_vectrorizer.pkl')
vectorizerRecommended = joblib.load(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Recommendation_flight\Recommendation_service_vectrorizer.pkl')
...
loadModel_EnternamentService = pickle.load(open(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Enternment_services\Enternment_Services_Model.sav', 'rb'))
loadModel_FoodCatering = pickle.load(open(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Food_Catering\trained_food_catering_services.sav', 'rb'))
loadModel_GroundService = pickle.load(open(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Ground_service\trained_ground_services.sav', 'rb'))
loadModel_SeatComfort = pickle.load(open(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Comfort_seat_service\trained_seat_comfort_services.sav', 'rb'))
loadModel_InFlight = pickle.load(open(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\In_Flight_services\trained_InFlight_services.sav', 'rb'))
loadModel_RecommendedService = pickle.load(open(
    r'C:\Users\aparm\Desktop\airlines\Big-Data-Analytics-for-Airline-Company\Final model with transformation\Recommendation_flight\trained_Recommended_services.sav', 'rb'))
